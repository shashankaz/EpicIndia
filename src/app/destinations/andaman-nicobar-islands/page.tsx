      ...
      <div id="container-destination">
        ...
        <div id="main-destination">
          <h1 id="title-destination">
            Andaman and Nicobar Islands: A Paradise of Pristine Beauty
          </h1>

          <Fade cascade damping={0.01} triggerOnce>
            <p>
              The Andaman and Nicobar Islands, nestled in the Bay of Bengal,
              beckon travelers with their azure waters, white sandy beaches,
            ...
            <p>
              The Andaman and Nicobar Islands boast some of the most stunning
              beaches in the world, each with its unique charm and allure.
            </p>
            <h3>Radhanagar Beach: Tranquil Serenity</h3>
            <p>
              Ranked among the best beaches globally, Radhanagar Beach on
              Havelock Island is a picture-perfect paradise. Its pristine
              waters, powdery white sands, and breathtaking sunsets make it a
              favorite spot for relaxation and romance.
            </p>
            <h3>Elephant Beach: Adventure and Marine Marvels</h3>
            <p>
            ...
            <p>
              Beyond its beaches, the Andaman and Nicobar Islands are home to
              dense rainforests teeming with biodiversity and rare species.
            </p>
            ...
            <h3>Chidiya Tapu: Bird Watching Haven</h3>
            <p>
              Chidiya Tapu, or Bird Island, is a paradise for birdwatchers, with
              its diverse avian population and stunning coastal vistas. Spot
              endemic birds like the Andaman wood pigeon, white-headed starling,
              and the colorful Andaman drongo in their natural habitat.
            </p>
            <h1>Cultural Melting Pot and Historical Treasures</h1>
            <p>
              The Andaman and Nicobar Islands are not just about natural beauty;
              they also hold a rich tapestry of cultural heritage and historical
              significance.
            </p>
            ...
            <p>
              Indulge your taste buds in the flavors of Andamanese and
              Nicobarese cuisine, influenced by coastal ingredients and
            ...
            <p>
              The Andaman and Nicobar Islands are a haven for underwater
              enthusiasts, with pristine dive sites and diverse marine life.
            </p>
            <h3>Havelock Island Diving</h3>
            <p>
            ...
            <p>
              For snorkelers, spots like Neil Island, North Bay Island, and
              Jolly Buoy Island provide crystal-clear waters teeming with marine
              biodiversity. Swim alongside vibrant corals, playful dolphins, and
              schools of tropical fish for an unforgettable snorkeling
              adventure.
            </p>
            <h1>Eco-Tourism and Conservation Efforts</h1>
            <p>
              The Andaman and Nicobar Islands prioritize eco-tourism and
              sustainable practices to preserve their natural heritage.
            </p>
            <h3>Protected Areas</h3>
            <p>
              With marine protected areas and conservation zones, the islands
              safeguard fragile ecosystems, coral reefs, and endangered species.
              Responsible tourism initiatives promote environmental awareness
              and minimize human impact on delicate ecosystems.
            </p>
            ...
            <p>
              The Andaman and Nicobar Islands offer a tropical retreat like no
              other, where natural beauty, cultural heritage, and adventure
              converge to create unforgettable experiences. Whether you seek
              relaxation on pristine beaches, thrilling dives into azure waters,
